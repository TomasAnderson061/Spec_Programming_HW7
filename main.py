...
vowel_alphabet = 'аеёиоуыэюя'
phrase = input('Фраза: ').split()
vowel_letters = [sum([True for i in word if i.lower() in vowel_alphabet]) for word in phrase]
...
def print_operation_table(operation, num_rows, num_columns):
    ...
    for k in list:
        print(*[f'{res}\t' for res in k])

print_operation_table(lambda x, y: x * y, int(input('Число строк (num_rows): ')), int(input('Число столбцов (num_columns): ')))